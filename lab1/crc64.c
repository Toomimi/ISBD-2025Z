// Based on: https://android.googlesource.com/kernel/common/+/refs/tags/android16-6.12-2025-06_r17/lib/crc64.c
 ...
 */
uint64_t crc64_update(uint64_t crc, const void *p, size_t len)
{
	size_t i, t;
